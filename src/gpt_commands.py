...
def get_astrological_insight(birth_date: str, birth_time: str, aspect: str) -> str:
    """
    ...
    """
    prompt = f"""As an expert astrologer, provide insights about {aspect} for someone born on {birth_date} at {birth_time}.
